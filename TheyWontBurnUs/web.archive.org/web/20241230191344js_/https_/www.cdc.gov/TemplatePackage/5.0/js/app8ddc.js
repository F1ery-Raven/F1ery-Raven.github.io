...
(function () {
	...
	if ('function' !== typeof window.DOMPurify) {
		CDC.Common.loadScript('https://web.archive.org/web/20241230191344/https://www.cdc.gov/TemplatePackage/contrib/libs/dompurify/latest/purify.min.js');
	}
})();
...
class CDCFeatures {
	...
	handleEmailForms() {
		$('.dfe-block--email_signup_form form').each((i, form) => {
			form.setAttribute('action', 'https://web.archive.org/web/20241230191344/https://tools.cdc.gov/campaignproxyservice/subscriptions.aspx');
		});
	}
	...
	handleSocialSharing() {
		...
		url = isProd || CDC.Common.getParamSwitch('cdcdebug') ? url : 'https://web.archive.org/web/20241230191344/https://www.cdc.gov';
		var props = {
		...
		// Facebook
		socialUrl = 'https://web.archive.org/web/20241230191344/https://www.facebook.com/sharer/sharer.php?u=' + props.url;
		$('.page-share-facebook').attr('href', socialUrl);

		// Twitter
		socialUrl = 'https://web.archive.org/web/20241230191344/http://twitter.com/share?url=' + props.url + '&text=' + props.title;
		$('.page-share-twitter').attr('href', socialUrl);

		// LinkedIn
		socialUrl = 'https://web.archive.org/web/20241230191344/https://www.linkedin.com/shareArticle?url=' + props.url + '&title=' + props.title;
				...
				siteAlert.innerHTML = `
					<div class="alert alert-danger my-2 p-2 text-center" role="status" aria-live="polite" style="border:0;color:#000;">
						<div style="max-width:800px; margin: auto">
							This is a complete historical copy of <a href="https://web.archive.org/web/20241230191344/https://www.cdc.gov">www.cdc.gov</a> as it appeared on May 15 before relaunch. This site will be available through November 2024.
							For the new CDC.gov, visit <b><a href="https://web.archive.org/web/20241230191344/https://www.cdc.gov">www.cdc.gov</a></b>.
						</div>
					</div>
				`;
			}
	...
	ytPrintLinkHandler() {
		...
		allVideos.forEach((video) => {
			...
			const fetchData = fetch(`https://web.archive.org/web/20241230191344/https://noembed.com/embed?url=https://www.youtube.com/watch?v=${id}`);
	...
	printLink() {
		...
		var imageBeaconUrl = 'https://web.archive.org/web/20241230191344/https://www.cdc.gov/wcms/s.gif?action=print' +
			'&rs=' + account +
...
class CDC_Lang {
	...
	static LANGS = {
		...
		es: {
			name: 'Spanish',
			label: 'Español',
			mpt: 'https://web.archive.org/web/20241230191344/https://espanol.cdc.gov/enes',
		},
		...
		vi: {
			name: 'Vietnamese',
			label: 'Tiếng Việt',
			mpt: 'https://web.archive.org/web/20241230191344/https://vietnamese.cdc.gov',
		},
		...
		pt: {
			name: 'Portuguese',
			label: 'Português',
			mpt: 'https://web.archive.org/web/20241230191344/https://portugues.cdc.gov',
		},
...
class CDCSearch {
	constructor() {
		...
		this.currentResults = [];
		this.siteLimit = null;
		this.searchResultsUrl = CDC.Common.cleanString( window.CDC_CONFIG?.search_url || 'https://web.archive.org/web/20241230191344/https://search.cdc.gov/search/' );
		this.searchTypeaheadSolr = CDC.Common.cleanString( window.CDC_CONFIG?.search_typeahead || 'https://web.archive.org/web/20241230191344/https://search.cdc.gov/srch/internet_autocomplete/autocomplete' );
...
/*
     ...
     INTERNET ARCHIVE ON 18:43:17 Feb 02, 2025.
...
playback timings (ms):
  ...
  esindex: 0.011
  cdx.remote: 7.757
  LoadShardBlock: 148.081 (3)
  PetaboxLoader3.datanode: 215.11 (4)
  load_resource: 164.638
  PetaboxLoader3.resolve: 80.743
*/